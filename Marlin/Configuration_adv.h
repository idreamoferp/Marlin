...
#define HOMING_BUMP_MM      { 10, 10, 15, 15, 15, 5 }       // (mm) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR {  4,  4,  4,  4,  4, 2 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
